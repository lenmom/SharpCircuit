...
namespace SharpCircuitTest
{
    ...
    public class OpAmpTest
    {
        ...
        public void SimpleOpAmpTest()
        {
            ...
            OpAmp opAmp0 = sim.Create<OpAmp>();
            Output analogOut0 = sim.Create<Output>();
        ...
        public void GyratorTest()
        {
            ...
            VoltageInput square0 = sim.Create<VoltageInput>(Voltage.WaveType.SQUARE);
            square0.frequency = 20;

            Resistor res0 = sim.Create<Resistor>(1000);
            Resistor res1 = sim.Create<Resistor>(20000);
            CapacitorElm cap0 = sim.Create<CapacitorElm>(2.5E-7);
            OpAmp opAmp0 = sim.Create<OpAmp>();
            ...
            VoltageInput square1 = sim.Create<VoltageInput>(Voltage.WaveType.SQUARE);
            square1.frequency = 20;

            Resistor res3 = sim.Create<Resistor>(1000);
            InductorElm induct0 = sim.Create<InductorElm>(5);
            ...
            List<ScopeFrame> scope0 = sim.Watch(square0);
            List<ScopeFrame> scope1 = sim.Watch(square1);
        ...
        public void CapacitanceMultiplierTest()
        {
            ...
            Resistor res0 = sim.Create<Resistor>(100000);
            Resistor res1 = sim.Create<Resistor>(1000);
            CapacitorElm cap0 = sim.Create<CapacitorElm>(1E-7);
            OpAmp opAmp0 = sim.Create<OpAmp>();
            Ground grnd0 = sim.Create<Ground>();
            ...
            CapacitorElm cap1 = sim.Create<CapacitorElm>(1E-5);
            Resistor res2 = sim.Create<Resistor>(1000);
            Ground grnd1 = sim.Create<Ground>();
            ...
            List<ScopeFrame> scope0 = sim.Watch(cap0);
            List<ScopeFrame> scope1 = sim.Watch(cap1);
