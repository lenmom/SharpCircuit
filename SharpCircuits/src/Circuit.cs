...
namespace SharpCircuit
{
    ...
    public class Circuit
    {
        ...
        public class Lead
        {
            ...
            public Lead(ICircuitElement e, int index) { elem = e; ndx = index; }
        }
        ...
        private double _timeStep = 5E-6;
        private List<long> nodeList = new List<long>();
        private ICircuitElement[] voltageSources;
        private double[][] circuitMatrix; // contains circuit state
        ...
        private bool circuitNonLinear,
             circuitNeedsMap;
        private Dictionary<ICircuitElement, List<ScopeFrame>> scopeMap;
        ...
        private class FindPathInfo
        {
            ...
            private bool[] used;
            private int dest;
            private ICircuitElement firstElm;
